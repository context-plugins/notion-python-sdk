...
class UnionTypeLookUp:
    ...
    _templates: ClassVar[dict[str, Callable]] = {
        ...
        "DatabasesRequestIcon": lambda: OneOf(
            [
                LeafType(Emoji),
                LeafType(ExternalFile),
            ],
            Context.create(
               is_optional=True,
            ),
        ),
        "DatabasesRequest1Icon": lambda: OneOf(
            [
                LeafType(Emoji),
                LeafType(ExternalFile),
            ],
        ...
        "PagesRequest1Icon": lambda: OneOf(
            [
                LeafType(Emoji),
                LeafType(ExternalFile),
            ],
